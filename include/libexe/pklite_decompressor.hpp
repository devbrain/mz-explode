...
class LIBEXE_EXPORT pklite_decompressor : public decompressor {
public:
    ...
    const char* name() const override { return "PKLITE"; }
...
private:
    ...
    pklite_params read_parameters(std::span<const uint8_t> data);
