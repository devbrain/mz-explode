...
template<> struct enable_bitmask_operators<pe_file_characteristics> {
    static constexpr bool enable = true;
};

template<> struct enable_bitmask_operators<pe_dll_characteristics> {
    static constexpr bool enable = true;
};

template<> struct enable_bitmask_operators<pe_section_characteristics> {
    static constexpr bool enable = true;
};
