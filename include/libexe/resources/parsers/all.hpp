...
// Convenience header - includes all resource parsers

#ifndef LIBEXE_RESOURCES_PARSERS_ALL_HPP
#define LIBEXE_RESOURCES_PARSERS_ALL_HPP
...
#endif // LIBEXE_RESOURCES_PARSERS_ALL_HPP
