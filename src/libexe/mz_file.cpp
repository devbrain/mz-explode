...
mz_file mz_file::from_memory(std::span<const uint8_t> data) {
    ...
    try {
        ...
        file.e_cparhdr_ = dos_header.e_cparhdr;
        file.e_cs_ = dos_header.e_cs;
        file.e_ip_ = dos_header.e_ip;
        file.e_ss_ = dos_header.e_ss;
        file.e_sp_ = dos_header.e_sp;
        file.e_minalloc_ = dos_header.e_minalloc;
        file.e_maxalloc_ = dos_header.e_maxalloc;
        file.e_crlc_ = dos_header.e_crlc;
