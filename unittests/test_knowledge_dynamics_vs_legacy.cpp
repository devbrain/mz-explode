// MD5 verification test: Knowledge Dynamics decompressor vs legacy implementation
// Ensures byte-identical output for all Knowledge Dynamics variants
...
TEST_CASE("Knowledge Dynamics MD5 verification against legacy implementation") {
    SUBCASE("Knowledge Dynamics LEX produces identical output") {
        ...
        MESSAGE("KD LEX: actual=", actual, ", expected=", expected);
    }
    ...
    SUBCASE("Knowledge Dynamics DOT produces identical output") {
        ...
        CHECK(actual == expected);
        MESSAGE("KD DOT: actual=", actual, ", expected=", expected);
    }
    ...
    SUBCASE("Knowledge Dynamics TNT produces identical output") {
        ...
        CHECK(actual == expected);
        MESSAGE("KD TNT: actual=", actual, ", expected=", expected);
    }
}
